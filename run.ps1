...
$expertCaseData = [IO.File]::ReadAllText((Join-Path $caseRoot 'expert.json'), $utf8) | ConvertFrom-Json
$cases = @($easyCaseData, $caseData, $hardCaseData, $expertCaseData)
